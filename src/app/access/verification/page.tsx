...
export default async function VerificationPage() {
  ...
  return (
    <div className="stack">
      <PageHead
        title="Revocation verification"
        subtitle="Whether access was actually removed, per person and per system. Derived on every read from the revocation records and the live session list — never stored as a flag."
      />
