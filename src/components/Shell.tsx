...
function navGroups(openRequests: number): NavGroup[] {
  return [
    ...
    },
    {
      ...
      ready: false,
      children: [
        { href: "/discovery/scans", label: "Scan configuration", ready: false },
        { href: "/discovery/sources", label: "Discovered sources", ready: false },
        { href: "/discovery/rot", label: "ROT & duplicates", ready: false },
        { href: "/discovery/purposes", label: "Purpose tagging", ready: false },
      ],
    },
    {
      key: "consent",
